...
# 策略分类（两段式选择第一步：是否加入机器学习）
STRATEGY_CATEGORY_LABELS = {
    CATEGORY_CLASSIC: "否，仅经典/规则算法",
    CATEGORY_ML: "是，加入机器学习算法",
}
...
# 板块/功能权限矩阵与 resolve_role 已拆到 ui.common.permissions（单文件 ≤200 行规则）
from ui.common.permissions import *  # noqa: F401,F403
